...
IPAdd = input("Type your IP Address to Telnet: ")
UN = input("Type Username to access the router: ")
PW =  input("Password for Username: ")
EPW =  input("Type Password Preivilege: ")
...
RConfig = input("Do you want to configure Router?")

while RConfig.upper() == "YES":
    PAns =  input("Do you want to configure Routing Protocol?\nA. Yes\n ")
    while PAns.upper() == "A":
        Protocol = input("which protocol you want to configure?\nA. RIP \nB OSPF\n")
        if Protocol.upper() == "A":
            TA.write("router rip")
            ...
            RNID = input("PLease Enter the network ID: ")
